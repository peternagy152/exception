...
if( $language == 'en') {
  $page_new_arrival = get_field('head_en');
} else {
  $page_new_arrival = get_field('head');
}
?>
<style>
...
<div id="page" class="site">
  ...
  <div class="site-content page_list">
    <div class="section_title_list">
      <div class="grid">
          <h3><?php echo $page_new_arrival['title']; ?></h3>
          ...
          <div class="grid">
            ...
            <div class="product_container section_new">
              <ul class="products_list products">
                <?php
                $new_arrival_products = mitch_get_new_arrival_products_ids(20);
